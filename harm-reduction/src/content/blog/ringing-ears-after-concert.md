---
title: "Ringing Ears After a Concert: What Actually Helps"
description: "Ringing ears after a concert? Nearly all supplement evidence is for prevention, not treatment. What actually helps, and when to see a doctor."
date: 2026-08-15
tags: ["hearing", "tinnitus", "earplugs", "supplements", "harm reduction"]
author: "Jordan Mercer"
---

**Ringing in your ears after a concert usually fades on its own over 16 to 48 hours, and there is no supplement with good evidence that it speeds that up.** Almost every study cited for "supplements for tinnitus" tested whether a pill taken **before** noise exposure prevented damage, not whether anything fixed ringing that had already started. Those are different questions with different answers, and supplement marketing collapses them on purpose. Here is what the trials actually found, what to do tonight, and the one symptom that means calling a doctor this week rather than waiting.

## Quick answers

**Will a supplement stop the ringing I have right now?** No supplement has been shown to shorten post-concert ringing. The trials that get cited tested prevention, dosed before noise exposure, in different populations.

**How long should ringing last?** Typically 16 to 48 hours. It should be clearly better the next morning.

**What actually helps?** Silence, time, and no second loud night stacked on top of the first. Unglamorous, and it is the whole list.
...
That design tells you nothing about swallowing a capsule at 2am after a show, when the exposure already happened and the cascade already ran. A label citing "clinical research on hearing" is almost always pointing at a prevention trial. And even the prevention literature is weaker than it looks.

---

## What actually helps ringing you already have

- **Stop the exposure.** Give your ears genuine quiet, not headphones at a lower volume. Quiet is the intervention.
- **Give it 16 to 48 hours.** Ringing after a loud night is usually a temporary threshold shift, and the sensitivity generally returns on its own.
...
- **Watch the calendar.** Ringing still there after a week or two, or that never fades, is worth an audiogram.

That is the list. It is short because the evidence is short.

---

## The one symptom that changes everything

Both ears ringing and dull, recovering by tomorrow, is the ordinary story. **One ear that stays clearly worse than the other is a different question entirely.**

Sudden sensorineural hearing loss is one-sided, and its treatment window is measured in days to two weeks, after which the options get worse. Giving it a week, then another week, walks straight past that window. The guideline timing, what a doctor will do, and how to book the appointment are all in [muffled ear after a concert: when it is an emergency](/blog/muffled-ear-after-concert.html). If one ear is worse, read that one instead of this one.
...
There is no supplement with good evidence for ringing you already have. Zinc has been tested and failed, ginkgo shows little to no effect in Cochrane's review, and the vitamin A/C/E plus magnesium combination failed against music-induced threshold shift under ideal dosing. What works is quiet, time, and not repeating the exposure. **If one ear stays muffled past 48 hours, stop researching supplements and get an audiogram this week**, per our [muffled ear guide](/blog/muffled-ear-after-concert.html).
