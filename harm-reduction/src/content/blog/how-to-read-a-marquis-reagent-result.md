---
title: "How to Read a Marquis Reagent Test Result"
description: "What each Marquis reagent color means: MDMA turns purple to black, meth and amphetamine turn orange. A full color chart and how to avoid misreads."
date: 2026-06-10
tags: ["test kits", "drug checking", "mdma", "marquis reagent", "harm reduction"]
...
**Can Marquis detect fentanyl?** No. Marquis cannot detect fentanyl, and fentanyl can be present even when the color looks "right." Always also use a [fentanyl test strip](/blog/how-to-use-fentanyl-test-strips.html).

**Where do you get a Marquis kit?** [DanceSafe sells Marquis reagent](https://dancesafe.org/r/ravewellness/) individually and in their [complete 9-reagent set](https://dancesafe.org/product/complete-set-of-all-9-testing-kits/r/ravewellness/).
...
| Substance | Marquis color |
|-----------|---------------|
| **MDMA** | **Purple → black** |
| **MDA** | **Purple → black** (looks the same as MDMA) |
| Amphetamine | Orange → brown |
| Methamphetamine | Orange → brown |
| DXM (dextromethorphan) | Gray → black, often slow |
| 2C-B and many 2C-x | Yellow → green |
| Opioids (heroin, morphine) | Purple (different shade, context matters) |
| Ketamine | No reaction (stays yellow) |
| Cocaine | No reaction (stays yellow) |
| Sugars / inert fillers | No reaction, or slow brown |
...
*Sources: [PMID 14594341](https://pubmed.ncbi.nlm.nih.gov/14594341/) | [PMC6338488](https://pmc.ncbi.nlm.nih.gov/articles/PMC6338488/) | [PMC7255931](https://pmc.ncbi.nlm.nih.gov/articles/PMC7255931/)*
