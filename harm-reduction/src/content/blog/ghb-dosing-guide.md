...
description: "GHB concentration varies between batches, so start at 0.5mL of an unknown source. Why the 1mL rule is not a safe default, and why redosing kills."
date: 2026-05-18
lastmod: 2026-08-15
...
GHB is synthesized as a powder or solution and sold as a liquid. There is no pharmaceutical-grade recreational supply, no standard concentration, and no labeling requirement. **Concentrations in the recreational market range from roughly 0.5g/mL to 1.5g/mL or higher**, depending on the source ([PMID 22746383](https://pubmed.ncbi.nlm.nih.gov/22746383/)).
...
[Oral syringes on Amazon](https://www.amazon.com/s?k=oral+syringe+1ml+5ml&tag=ravewellness01-20) -- 1mL and 5mL sizes, available in multi-packs for a few dollars. This is one of the most cost-effective harm reduction tools for GHB specifically.
...
For a broader overview of GHB effects and risks, see the [GHB harm reduction guide](/ghb.html). For dangerous combinations beyond alcohol, see the [interaction checker](/interactions.html). For general harm reduction, visit the [FAQ](/faq.html).

---

*Sources: [PMID 26074743](https://pubmed.ncbi.nlm.nih.gov/26074743/) | [PMID 33417072](https://pubmed.ncbi.nlm.nih.gov/33417072/) | [PMID 8299669](https://pubmed.ncbi.nlm.nih.gov/8299669/) | [PMID 22746383](https://pubmed.ncbi.nlm.nih.gov/22746383/)*
