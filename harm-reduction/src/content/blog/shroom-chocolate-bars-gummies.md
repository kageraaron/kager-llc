---
title: "Shroom Chocolate Bars and Gummies: What Is In Them"
description: "Lab tests of retail shroom gummies and bars found no psilocybin, plus synthetic tryptamines, kava and THC. What the data shows and what to do."
date: 2026-08-14
tags: ["psilocybin", "mushrooms", "drug checking", "harm reduction"]
author: "Jordan Mercer"
---

Smoke shops, gas stations and online storefronts now sell chocolate bars and gummies branded as "magic mushroom," "microdose" or "nootropic mushroom" products. Three separate laboratory studies have bought these off retail shelves and analysed them, and the results agree: the word "mushroom" on the package predicts almost nothing about what is inside. The dangerous failure mode is not that the product is fake. It is that it often contains a different drug, at a dose nobody disclosed.

## Quick answers

**Do shroom gummies and chocolate bars contain psilocybin?** Often not. In a 2025 analysis of 12 products bought at Portland, Oregon retail shops, no psilocybin was detected in any of them, including one gummy labelled as containing 100 mg of psilocybin per piece.

**So they are just placebos?** No, and that is the point. Of those 12 products, 8 contained active ingredients that were not on the label, including synthetic tryptamines, kava, cannabis extract and caffeine. Four contained nothing active at all.

**What is 4-AcO-DMT and why does it turn up in these?** It is a synthetic tryptamine (psilacetin) that is metabolised to psilocin. A separate Portland study found it in 6 of 8 gummy products. It is a lab-made compound with a thin human safety record, not a mushroom extract.

**Are Amanita muscaria products what they claim?** Not reliably. One study found no ibotenic acid or muscimol in the two products claiming Amanita extracts, and found serotonergic tryptamines instead. A different study found muscimol and muscarine but no ibotenic acid. Neither found labelling that matched contents.

**Did people actually get hurt?** Yes. The 2024 Diamond Shruumz outbreak produced 180 reported poisoning cases across 34 states, with 73 hospitalisations, 38 intensive care admissions, 29 intubations and two deaths.
...
If you want the contrast: psilocybin from mushrooms has a genuinely wide physiological safety margin, which we cover in [can you overdose on magic mushrooms](/blog/can-you-overdose-on-mushrooms.html). That reasoning does not transfer to a product whose active ingredient is unknown, unmeasured and possibly a synthetic compound with no published human toxicology.
...
Honestly, not well. A reagent such as Ehrlich turns purple in the presence of indoles, so it will react to psilocin, 4-AcO-DMT and other tryptamines alike. Three problems follow:

1. **It cannot tell them apart.** Purple means "an indole is here," not "psilocybin is here." Our [reagent colour chart](/reagent-chart.html) and the [Ehrlich reagent guide](/blog/ehrlich-reagent-color-chart.html) explain what these reactions do and do not distinguish.
2. **It cannot count milligrams.** Colour intensity is not dose. Dose is the entire problem with these products.
3. **The matrix ruins it.** Sugar, gelatin, cocoa butter and fats interfere with colour development, so a gummy or chocolate is close to a worst case sample for a colour test.

A no-colour result on something sold as psilocybin is still informative in one direction: it suggests no indole is present. A [reagent kit](/kits) is worth owning for powders and pills, but treat it as a weak tool for edibles, not a clearance.
...
Across 47 products in three published analyses, the label was a poor guide to the contents in most cases. A professional wrapper, a QR code or a claimed lab result changes nothing, because no enforced standard sits behind any of it. An identified whole mushroom from a known source has a far more predictable composition than a manufactured edible, with the serious caveat that misidentification kills people, which we cover in [psilocybin lookalikes and deadly Galerina](/blog/psilocybin-lookalikes-galerina.html).

For dosing, preparation and what to do when a trip goes badly, see our [psilocybin harm reduction guide](/psilocybin.html) and [how to stop a bad trip](/blog/how-to-stop-a-bad-trip.html).
