...
**Is it permanent?** Often not. In the Sussex series, symptoms generally resolved and foveal structure recovered partially or fully after patients stopped using ([PMID 28396339](https://pubmed.ncbi.nlm.nih.gov/28396339/)). Recovery is not guaranteed, and continued use after symptoms appear is what turns a reversible injury into a lasting one.
...
**If any of these appear, stop using poppers and get an eye exam.** The single strongest predictor of whether this resolves is whether you stop. Follow-up in the Sussex series ran a median of 5 months, and symptomatic resolution with partial to full recovery of foveal architecture was the general pattern after abstention ([PMID 28396339](https://pubmed.ncbi.nlm.nih.gov/28396339/)).
...
**Never swallow poppers.** Ingestion causes methemoglobinemia, where hemoglobin can no longer carry oxygen, and it escalates fast. A 2025 review of UK deaths from alkyl nitrites focuses specifically on swallowing fatalities ([PMID 39860433](https://pubmed.ncbi.nlm.nih.gov/39860433/)). The antidote, methylene blue, exists only in hospitals. If someone swallows poppers, call emergency services immediately.
...
*Sources: [PMID 28396339](https://pubmed.ncbi.nlm.nih.gov/28396339/) Rewbury et al., Br J Ophthalmol, 2017 | [PMID 35938499](https://pubmed.ncbi.nlm.nih.gov/35938499/) Bartolo et al., Semin Ophthalmol, 2023 | [PMID 39860433](https://pubmed.ncbi.nlm.nih.gov/39860433/) Corkery et al., J Clin Med, 2025*
