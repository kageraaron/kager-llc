...
For 5-HTP supplementation after a candy flip, follow the same timing rule as for standalone MDMA: **wait at least 24 hours after your last dose** before taking it. See our [MDMA harm reduction guide](/mdma.html) for the full comedown and supplement protocol.
...
For full individual drug profiles, see our [MDMA harm reduction guide](/mdma.html) and [LSD harm reduction guide](/lsd.html). Before combining with any additional substances, check the [interaction checker](/interactions.html), there is a specific MDMA + LSD entry.
