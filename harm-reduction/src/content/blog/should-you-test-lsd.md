---
title: "Should You Test LSD? The NBOMe Risk Explained"
description: "Yes, you should test LSD. Blotter sold as acid is sometimes NBOMe, which can be lethal. How an Ehrlich reagent kit catches it, and what it can't tell you."
date: 2026-06-10
tags: ["lsd", "test kits", "drug checking", "nbome", "harm reduction"]
...
**Is LSD itself dangerous to your body?** No drug is risk-free, but LSD has an unusually high physiological safety margin. There are documented cases of people accidentally taking hundreds of times a normal dose and surviving without organ damage ([PMID 32048609](https://pubmed.ncbi.nlm.nih.gov/32048609/)). The danger is almost entirely about what your "LSD" actually is.
...
LSD's own toxicity is remarkably low. A 2020 case series in the *Journal of Studies on Alcohol and Drugs* documented three accidental massive overdoses, including a woman who insufflated an estimated 55 mg of pure LSD (roughly 550 times a recreational dose) and survived with no lasting physical harm ([PMID 32048609](https://pubmed.ncbi.nlm.nih.gov/32048609/)). The real-world risks of genuine LSD are psychological (a difficult trip) and behavioral (injury, dangerous interactions), not direct organ toxicity. For the interaction that genuinely does cause seizures, see our guide on [LSD and lithium](/blog/lsd-and-lithium.html).
...
Unlike LSD, NBOMe compounds have a **steep, dangerous dose-response curve** and significant physical toxicity. Documented effects include severe agitation and delirium, tachycardia and hypertension, hyperthermia, clonus and tonic-clonic seizures, rhabdomyolysis (muscle breakdown that can cause kidney failure), and death. A case series from Indiana documented two fatal intoxications in teenagers tied to 25B-NBOMe and 25I-NBOMe ([PMID 26378133](https://pubmed.ncbi.nlm.nih.gov/26378133/)). Other analytically confirmed reports describe life-threatening intoxication and a suicide attempt in someone who believed they had taken "good LSD" ([PMID 23473462](https://pubmed.ncbi.nlm.nih.gov/23473462/), [PMC4220298](https://pmc.ncbi.nlm.nih.gov/articles/PMC4220298/)).
...
1. **Cut a small corner** off the tab (about a quarter). You do not need the whole thing.
2. **Place it on a white ceramic surface** or the test tray, or drop it straight into an Ehrlich test tube if your kit uses that format.
3. **Add one or two drops of Ehrlich reagent** directly onto the paper.
4. **Wait two to five minutes.** An indole like LSD turns the spot **purple to pink/magenta**. The reaction can be slow, so give it time.
5. **Read the result against the kit's chart** under white light.
...
- **It does not detect NBOMe directly.** A negative (no color) result is informative precisely because it means "not LSD," but Ehrlich cannot tell you *what* the non-reacting substance is. Lab methods like a dedicated 25-NBOMe spot test or mass spectrometry are needed for that ([PMID 32744773](https://pubmed.ncbi.nlm.nih.gov/32744773/)).
...
If you are at an event with a [drug checking service](/blog/drug-checking-services-festivals.html) that runs spectrometry, that gives far more information than any colorimetric kit. For everyone else, an at-home Ehrlich test is the realistic baseline.
...
*Sources: [PMID 32048609](https://pubmed.ncbi.nlm.nih.gov/32048609/) | [PMID 26378133](https://pubmed.ncbi.nlm.nih.gov/26378133/) | [PMID 23473462](https://pubmed.ncbi.nlm.nih.gov/23473462/) | [PMC4220298](https://pmc.ncbi.nlm.nih.gov/articles/PMC4220298/) | [PMID 32744773](https://pubmed.ncbi.nlm.nih.gov/32744773/)*
