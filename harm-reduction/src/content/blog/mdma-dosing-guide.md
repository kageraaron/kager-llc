...
**Testing your supply before dosing is not optional if you care about safe dosing.** A reagent test (Marquis + Simon's reagents) tells you whether MDMA is the primary active substance. A fentanyl test strip tells you whether fentanyl is present. The [DanceSafe complete 9-kit testing set](https://dancesafe.org/product/complete-set-of-all-9-testing-kits/r/ravewellness/) covers all the reagents you need. Use both before every session, not just once.
