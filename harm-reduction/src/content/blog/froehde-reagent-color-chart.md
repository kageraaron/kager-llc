...
|-----------|---------------|
| **MDMA** | **Blue-tinted black** |
| **MDA** | **Blue-tinted black** (looks the same as MDMA) |
| Amphetamine | No reaction |
| Methamphetamine | No reaction |
| Cocaine | No reaction |
| Ketamine | No reaction |
| **PMMA** | **Very light green** |
| 2C-B | Bright yellow through olive to near-black, often with a yellow ring |
| 2C-I | Amber through to very dark maroon-black |
| Mescaline | Olive-yellow to mustard to amber-brown |
| Heroin | Pink to deep purple |
| Oxycodone | No reaction, light yellow, or sky blue |
| Mephedrone (4-MMC) | No reaction |
| 5-APB / 6-APB / 5-MAPB / 6-MAPB | Purple to black |
...
*Color reactions above are the expected reactions published in DanceSafe's reagent testing instruction pamphlet (version 17, spring 2024) and DanceSafe's reagent reaction update notes.*
