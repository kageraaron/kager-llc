...
|-----------|----------------|
| **MDMA** | **Dark brown to black** |
| **MDA** | **Dark brown to black** (looks the same as MDMA) |
| **Methamphetamine** | **Olive to yellow-green** |
| Amphetamine | No reaction |
| Cocaine | No reaction |
| **Ketamine** | **No reaction** on the current chart (see below) |
| 2C-B | Muddy light yellow through to dark greenish-gray |
| 2C-I | No reaction |
| Mescaline | Amber to orange-gold |
| Heroin | Amber to gold-brown |
| Oxycodone | No reaction, very light orange, or muddy blue-green-gray |
| Mephedrone (4-MMC) | Pale tan |
| PMMA | Dark olive green |
| 5-APB / 6-APB / 5-MAPB / 6-MAPB | Black |
| LSD | No reaction |
...
*Color reactions above are the expected reactions published in DanceSafe's reagent testing instruction pamphlet (version 17, spring 2024), DanceSafe's reagent reaction update notes, and DanceSafe's ketamine testing kit guidance.*
